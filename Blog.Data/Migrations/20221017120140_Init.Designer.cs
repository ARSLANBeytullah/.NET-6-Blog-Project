            ...
            modelBuilder.Entity("Blog.Entity.Entities.AppRole", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            ConcurrencyStamp = "1d7099ea-5360-4073-a260-b18017620896",
                            Name = "Superadmin",
                        ...
                        new
                        {
                            ...
                            ConcurrencyStamp = "ae99e06f-5eaa-4062-9620-51e003bf4785",
                            Name = "Admin",
                        ...
                        new
                        {
                            ...
                            ConcurrencyStamp = "7f02515d-dbc1-4091-82d3-c2ad72f1b603",
                            Name = "User",
                            NormalizedName = "USER"
                        });
                });
            ...
            modelBuilder.Entity("Blog.Entity.Entities.AppUser", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "19bd6fa9-38fc-47a6-a289-a52b95499d86",
                            ...
                            PasswordHash = "AQAAAAEAACcQAAAAEOriRFcCxfw1IuguDeQ2o2TJDuV23/TvNIgkvkbE0QCl7mwQVJD76NZ9aQ8rJXaG0g==",
                            PhoneNumber = "+905439999999",
                            PhoneNumberConfirmed = true,
                            SecurityStamp = "2bdf984d-6bc9-4aa5-8d0e-e965b62824b4",
                        ...
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "a3f9d147-7222-482e-b56f-4c3903b70352",
                            ...
                            PasswordHash = "AQAAAAEAACcQAAAAEN903+TNNjL9gSj+Ps6U6aEu9soV0B3Vw9NJat3HHqzbi6X78q6F+xfWHNRpVEA0Bg==",
                            PhoneNumber = "+905439999988",
                            PhoneNumberConfirmed = false,
                            SecurityStamp = "d1754530-87c8-4168-a564-9372c9dc074b",
                            TwoFactorEnabled = false,
            ...
            modelBuilder.Entity("Blog.Entity.Entities.Article", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("d3085fe3-66e8-430a-8fed-d7c0d1176fa3"),
                            ...
                            CreatedDate = new DateTime(2022, 10, 17, 15, 1, 40, 481, DateTimeKind.Local).AddTicks(3682),
                            ImageId = new Guid("f71f4b9a-aa60-461d-b398-de31001bf214"),
                            IsDeleted = false,
                        ...
                        new
                        {
                            Id = new Guid("d6481cbf-e72c-40d7-a417-341bdb861fa0"),
                            ...
                            CreatedBy = "Admin Test",
                            CreatedDate = new DateTime(2022, 10, 17, 15, 1, 40, 481, DateTimeKind.Local).AddTicks(3693),
                            ImageId = new Guid("d16a6ec7-8c50-4ab0-89a5-02b9a551f0fa"),
                            IsDeleted = false,
            ...
            modelBuilder.Entity("Blog.Entity.Entities.Category", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedBy = "Admin Test",
                            CreatedDate = new DateTime(2022, 10, 17, 15, 1, 40, 481, DateTimeKind.Local).AddTicks(3888),
                            IsDeleted = false,
                            Name = "ASP.NET Core"
                        },
                        new
                        {
                            ...
                            CreatedBy = "Admin Test",
                            CreatedDate = new DateTime(2022, 10, 17, 15, 1, 40, 481, DateTimeKind.Local).AddTicks(3891),
                            IsDeleted = false,
            ...
            modelBuilder.Entity("Blog.Entity.Entities.Image", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedBy = "Admin Test",
                            CreatedDate = new DateTime(2022, 10, 17, 15, 1, 40, 481, DateTimeKind.Local).AddTicks(4003),
                        ...
                        new
                        {
                            ...
                            CreatedBy = "Admin Test",
                            CreatedDate = new DateTime(2022, 10, 17, 15, 1, 40, 481, DateTimeKind.Local).AddTicks(4082),
